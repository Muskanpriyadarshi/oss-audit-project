...
| Field | Details |
|---|---|
| **Student Name** | *Muskan Priyadarshi* |
| **Registration Number** |  *24BCE10752*|
| **Chosen Software** | Git |
...
```bash
git clone https://github.com/Muskanpriyadarshi/oss-audit-project.git
...
```
MIT License — Copyright (c) 2026 [Muskan Priyadarshi]
